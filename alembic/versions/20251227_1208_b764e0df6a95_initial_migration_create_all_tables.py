...
def upgrade() -> None:
    ...
    op.execute('CREATE SCHEMA IF NOT EXISTS messages')
    ...
    op.create_index('idx_integration_logs_status', 'integration_logs', ['status'], unique=False, schema='integrations')
    op.create_index('idx_integration_logs_user', 'integration_logs', ['user_id', 'created_at'], unique=False, schema='integrations')
    op.create_index('idx_integration_logs_workflow', 'integration_logs', ['workflow_name'], unique=False, schema='integrations')
...
def downgrade() -> None:
    ...
    op.drop_index('idx_integration_logs_workflow', table_name='integration_logs', schema='integrations')
    op.drop_index('idx_integration_logs_user', table_name='integration_logs', schema='integrations')
    op.drop_index('idx_integration_logs_status', table_name='integration_logs', schema='integrations')
